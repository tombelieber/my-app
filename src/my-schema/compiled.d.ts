...
export namespace mypackage {
    ...
    class CustomMap implements ICustomMap {
         ...
         * @returns Writer
         */
        public static encode(message: mypackage.ICustomMap, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: mypackage.ICustomMap, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): mypackage.CustomMap;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): mypackage.CustomMap;
         ...
         */
        public static toObject(message: mypackage.CustomMap, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class MyModel implements IMyModel {
         ...
         * @returns Writer
         */
        public static encode(message: mypackage.IMyModel, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: mypackage.IMyModel, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): mypackage.MyModel;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): mypackage.MyModel;
         ...
         * @returns Plain object
         */
        public static toObject(message: mypackage.MyModel, options?: $protobuf.IConversionOptions): { [k: string]: any };
