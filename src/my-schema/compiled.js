...
export const mypackage = $root.mypackage = (() => {
    ...
    mypackage.CustomMap = (function() {
        ...
        CustomMap.encode = function encode(message, writer) {
            ...
            if (message.b != null && Object.hasOwnProperty.call(message, "b"))
                for (let keys = Object.keys(message.b), i = 0; i < keys.length; ++i)
                    writer.uint32(/* id 1, wireType 2 =*/10).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 0 =*/16).bool(message.b[keys[i]]).ldelim();
            if (message.d != null && Object.hasOwnProperty.call(message, "d"))
                for (let keys = Object.keys(message.d), i = 0; i < keys.length; ++i)
                    writer.uint32(/* id 2, wireType 2 =*/18).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 1 =*/17).double(message.d[keys[i]]).ldelim();
            if (message.s != null && Object.hasOwnProperty.call(message, "s"))
                for (let keys = Object.keys(message.s), i = 0; i < keys.length; ++i)
                    writer.uint32(/* id 3, wireType 2 =*/26).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 2 =*/18).string(message.s[keys[i]]).ldelim();
            if (message.l != null && Object.hasOwnProperty.call(message, "l"))
                for (let keys = Object.keys(message.l), i = 0; i < keys.length; ++i)
                    writer.uint32(/* id 4, wireType 2 =*/34).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 1 =*/17).double(message.l[keys[i]]).ldelim();
            return writer;
        };
        ...
        CustomMap.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.mypackage.CustomMap(), key, value;
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                        if (message.b === $util.emptyObject)
                            message.b = {};
        ...
        CustomMap.verify = function verify(message) {
            ...
            if (message.b != null && message.hasOwnProperty("b")) {
                if (!$util.isObject(message.b))
                    return "b: object expected";
            ...
            if (message.d != null && message.hasOwnProperty("d")) {
                if (!$util.isObject(message.d))
                    return "d: object expected";
            ...
            if (message.s != null && message.hasOwnProperty("s")) {
                if (!$util.isObject(message.s))
                    return "s: object expected";
            ...
            if (message.l != null && message.hasOwnProperty("l")) {
                if (!$util.isObject(message.l))
                    return "l: object expected";
        ...
        CustomMap.fromObject = function fromObject(object) {
            if (object instanceof $root.mypackage.CustomMap)
                return object;
        ...
        CustomMap.toObject = function toObject(message, options) {
            ...
            if (message.d && (keys2 = Object.keys(message.d)).length) {
                object.d = {};
                for (let j = 0; j < keys2.length; ++j)
                    object.d[keys2[j]] = options.json && !isFinite(message.d[keys2[j]]) ? String(message.d[keys2[j]]) : message.d[keys2[j]];
            }
            ...
            if (message.l && (keys2 = Object.keys(message.l)).length) {
                object.l = {};
                for (let j = 0; j < keys2.length; ++j)
                    object.l[keys2[j]] = options.json && !isFinite(message.l[keys2[j]]) ? String(message.l[keys2[j]]) : message.l[keys2[j]];
            }
            return object;
        };
    ...
    mypackage.MyModel = (function() {
        ...
        MyModel.encode = function encode(message, writer) {
            ...
            if (message.oMap != null && Object.hasOwnProperty.call(message, "oMap"))
                $root.mypackage.CustomMap.encode(message.oMap, writer.uint32(/* id 19, wireType 2 =*/154).fork()).ldelim();
            if (message.pMap != null && Object.hasOwnProperty.call(message, "pMap"))
                $root.mypackage.CustomMap.encode(message.pMap, writer.uint32(/* id 20, wireType 2 =*/162).fork()).ldelim();
            return writer;
        };
        ...
        MyModel.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.mypackage.MyModel();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 19: {
                        message.oMap = $root.mypackage.CustomMap.decode(reader, reader.uint32());
                        break;
                    }
                case 20: {
                        message.pMap = $root.mypackage.CustomMap.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        MyModel.verify = function verify(message) {
            ...
            if (message.str4 != null && message.hasOwnProperty("str4"))
                if (!$util.isString(message.str4))
                    return "str4: string expected";
            if (message.str5 != null && message.hasOwnProperty("str5"))
                if (!$util.isString(message.str5))
                    return "str5: string expected";
            if (message.str6 != null && message.hasOwnProperty("str6"))
                if (!$util.isString(message.str6))
                    return "str6: string expected";
            if (message.bool1 != null && message.hasOwnProperty("bool1"))
                if (typeof message.bool1 !== "boolean")
                    return "bool1: boolean expected";
            if (message.bool2 != null && message.hasOwnProperty("bool2"))
                if (typeof message.bool2 !== "boolean")
                    return "bool2: boolean expected";
            if (message.bool3 != null && message.hasOwnProperty("bool3"))
                if (typeof message.bool3 !== "boolean")
                    return "bool3: boolean expected";
            if (message.bool4 != null && message.hasOwnProperty("bool4"))
                if (typeof message.bool4 !== "boolean")
                    return "bool4: boolean expected";
            if (message.bool5 != null && message.hasOwnProperty("bool5"))
                if (typeof message.bool5 !== "boolean")
                    return "bool5: boolean expected";
            if (message.bool6 != null && message.hasOwnProperty("bool6"))
                if (typeof message.bool6 !== "boolean")
                    return "bool6: boolean expected";
            ...
            if (message.num3 != null && message.hasOwnProperty("num3"))
                if (typeof message.num3 !== "number")
                    return "num3: number expected";
            if (message.num4 != null && message.hasOwnProperty("num4"))
                if (typeof message.num4 !== "number")
                    return "num4: number expected";
            if (message.num5 != null && message.hasOwnProperty("num5"))
                if (typeof message.num5 !== "number")
                    return "num5: number expected";
            if (message.num6 != null && message.hasOwnProperty("num6"))
                if (typeof message.num6 !== "number")
                    return "num6: number expected";
        ...
        MyModel.fromObject = function fromObject(object) {
            if (object instanceof $root.mypackage.MyModel)
                return object;
            ...
            if (object.str4 != null)
                message.str4 = String(object.str4);
            if (object.str5 != null)
                message.str5 = String(object.str5);
            if (object.str6 != null)
                message.str6 = String(object.str6);
            if (object.bool1 != null)
                message.bool1 = Boolean(object.bool1);
            if (object.bool2 != null)
                message.bool2 = Boolean(object.bool2);
            if (object.bool3 != null)
                message.bool3 = Boolean(object.bool3);
            if (object.bool4 != null)
                message.bool4 = Boolean(object.bool4);
            if (object.bool5 != null)
                message.bool5 = Boolean(object.bool5);
            if (object.bool6 != null)
                message.bool6 = Boolean(object.bool6);
            if (object.num1 != null)
                message.num1 = Number(object.num1);
            if (object.num2 != null)
                message.num2 = Number(object.num2);
            if (object.num3 != null)
                message.num3 = Number(object.num3);
            if (object.num4 != null)
                message.num4 = Number(object.num4);
            if (object.num5 != null)
                message.num5 = Number(object.num5);
            if (object.num6 != null)
                message.num6 = Number(object.num6);
            if (object.oMap != null) {
        ...
        MyModel.toObject = function toObject(message, options) {
            ...
            if (message.num3 != null && message.hasOwnProperty("num3"))
                object.num3 = options.json && !isFinite(message.num3) ? String(message.num3) : message.num3;
            if (message.num4 != null && message.hasOwnProperty("num4"))
                object.num4 = options.json && !isFinite(message.num4) ? String(message.num4) : message.num4;
            if (message.num5 != null && message.hasOwnProperty("num5"))
                object.num5 = options.json && !isFinite(message.num5) ? String(message.num5) : message.num5;
            if (message.num6 != null && message.hasOwnProperty("num6"))
                object.num6 = options.json && !isFinite(message.num6) ? String(message.num6) : message.num6;
            if (message.oMap != null && message.hasOwnProperty("oMap"))
